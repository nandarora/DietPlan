...
import Dinnervalue from '../actions/dinnerpostform';
import Dinnerpost from '../actions/dinnerpost';
import Dinnerdel from '../actions/dinnerdel';
import $ from 'jquery';
...
class Dinner extends React.Component{
    ...
    sub = (e) => {
        ...
        if (alpha) {
            this.props.Dinnervalue(this.state)
...
const mapstatetoprops =(state) => {
    return{
        posts: state.dinner,
        newpost: state.dinner.item
        
    }

}
export default connect(mapstatetoprops, {Dinnerpost, Dinnervalue, Dinnerdel})(Dinner) ;